...
import org.jclouds.ec2.xml.AllocateVPCAddressResponseHandler;
...
@VirtualHost
public interface ElasticIPAddressVPCApi {

    /**
     * Acquires an elastic IP address for use with your identity.
     *
     * @param region Elastic IP addresses are tied to a Region and cannot be mapped across Regions.
    ...
    @POST
    @Path("/")
    @XMLResponseParser(AllocateVPCAddressResponseHandler.class)
    @FormParams(keys = ACTION, values = "AllocateAddress")
    ElasticIPAddress allocateAddressInRegion(
     ...
     *
     * @param region   Elastic IP addresses are tied to a Region and cannot be mapped across Regions.
     * @param publicIp The IP address that you are releasing from your identity.
     * @see #allocateAddress
     * @see #describeAddresses
     * @see #associateAddress
     * @see #disassociateAddress
     ...
     *
     * @param region    Elastic IP addresses are tied to a Region and cannot be mapped across Regions.
     * @param publicIps Elastic IP address to describe.
     * @throws AWSResponseException if the requested publicIp is not found
     * @see #allocateAddress
     * @see #releaseAddress
